      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatePassword' : 'http://localhost:3000/api/v1/users/updateInfo';
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51IfGwUEmh4j6pUnqPsX6fijLEIiFN4amOJqiEldf5liIOSmUKL7bmmjWo5vvMjUgvwRNkzfUW0zvKTZtHt7g4LwB00AzLyRIyp'); // eslint-disable-next-line import/prefer-default-export
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // Create checkout form + chanre credit card
